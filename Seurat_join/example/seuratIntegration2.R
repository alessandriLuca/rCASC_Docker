...
#' 
#' @export
seuratIntegration2 <- function(group=c("sudo","docker"), scratch.folder, file1,file2, separator1,separator2,seed){
...
system(paste("cp ",data.folder2,"/",matrixName2,".",format2," ",scrat_tmp.folder,"/",sep=""))
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder1,"/dockerID -v ",scrat_tmp.folder,":/scratch -v ", data.folder1, ":/data -d docker.io/repbioinfo/seuratintegration Rscript /home/pre_processing2.R ",matrixName1," ",format1," ",separator1," ",matrixName2," ",format2," ",separator2," ",seed,sep="")
