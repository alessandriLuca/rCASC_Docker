...
/bin/cellranger-5.0.1/cellranger mkgtf /data/genome.gtf /data/output.gtf --attribute=gene_biotype:$3
...
cd /data
/bin/cellranger-5.0.1/cellranger mkref --genome=10XGenome --fasta=/data/genome.fa --genes=/data/output.gtf --nthreads=4
